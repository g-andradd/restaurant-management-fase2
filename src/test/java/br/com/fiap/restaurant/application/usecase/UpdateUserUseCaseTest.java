...
class UpdateUserUseCaseTest {
    ...
    void updatesDataWithoutChangingPasswordWhenSenhaAbsent() {
        var useCase = new UpdateUserUseCase(userRepository, passwordEncoder);
    ...
    void throwsWhenUserNotFound() {
        ...
        var command = new UpdateUserCommand(id, "Ana Silva", "ana@example.com", "ana.silva", null, null);
    ...
    void rejectsEmailOwnedByAnotherUser() {
        var useCase = new UpdateUserUseCase(userRepository, passwordEncoder);
        User user = User.create("Ana Silva", "ana@example.com", "ana.silva", "old-hash", null);
        var command = new UpdateUserCommand(user.getId(), "Ana Silva", "taken@example.com", "ana.silva", null, null);
    ...
    void rejectsLoginOwnedByAnotherUser() {
        var useCase = new UpdateUserUseCase(userRepository, passwordEncoder);
        User user = User.create("Ana Silva", "ana@example.com", "ana.silva", "old-hash", null);
        var command = new UpdateUserCommand(user.getId(), "Ana Silva", "ana@example.com", "taken.login", null, null);
