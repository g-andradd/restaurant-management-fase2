...
public final class User {
    ...
    public static User create(String nome, String email, String login, String senhaHash, String endereco) {
        var now = LocalDateTime.now();
        return new User(UUID.randomUUID(), nome, email, login, senhaHash, endereco, now, now);
    }

    public static User reconstitute(UUID id, String nome, String email, String login, String senhaHash,
                                     String endereco, LocalDateTime dataCriacao, LocalDateTime dataUltimaAlteracao) {
        return new User(id, nome, email, login, senhaHash, endereco, dataCriacao, dataUltimaAlteracao);
    }

    public void atualizarDados(String nome, String email, String login, String endereco) {
        validarNome(nome);
        validarEmail(email);
        validarLogin(login);
        this.nome = nome;
